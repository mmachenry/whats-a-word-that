...
var _mmachenry$whats_a_word_that$Main$mkUrl = F3(
	function (host, page, args) {
		var argStr = A2(
			_elm_lang$core$String$join,
			'&',
			A2(
...
var _mmachenry$whats_a_word_that$Main$onVisible = _elm_lang$core$Native_Platform.incomingPort(
	'onVisible',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (x0) {
...
var _mmachenry$whats_a_word_that$Main$Model = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {categoryInput: a, category: b, regex: c, error: d, visible: e, $continue: f, pages: g, subCategories: h, autoState: i, possibleCategories: j};
									};
								};
							};
						};
...
var _mmachenry$whats_a_word_that$Main$CategoryList = F2(
	function (a, b) {
		return {cmcontinue: a, pages: b};
	});
var _mmachenry$whats_a_word_that$Main$WikiPage = F3(
	function (a, b, c) {
		return {pageid: a, ns: b, title: c};
	});
var _mmachenry$whats_a_word_that$Main$categoryList = function () {
	var wikiPage = A4(
		_elm_lang$core$Json_Decode$map3,
		_mmachenry$whats_a_word_that$Main$WikiPage,
		A2(_elm_lang$core$Json_Decode$field, 'pageid', _elm_lang$core$Json_Decode$int),
		A2(_elm_lang$core$Json_Decode$field, 'ns', _elm_lang$core$Json_Decode$int),
		A2(_elm_lang$core$Json_Decode$field, 'title', _elm_lang$core$Json_Decode$string));
	var query = A2(
		_elm_lang$core$Json_Decode$field,
		'categorymembers',
		_elm_lang$core$Json_Decode$list(wikiPage));
	var $continue = A2(_elm_lang$core$Json_Decode$field, 'cmcontinue', _elm_lang$core$Json_Decode$string);
	return A3(
		_elm_lang$core$Json_Decode$map2,
		_mmachenry$whats_a_word_that$Main$CategoryList,
		_elm_lang$core$Json_Decode$maybe(
			A2(_elm_lang$core$Json_Decode$field, 'continue', $continue)),
		A2(_elm_lang$core$Json_Decode$field, 'query', query));
}();
var _mmachenry$whats_a_word_that$Main$SetAutoState = function (a) {
...
var _mmachenry$whats_a_word_that$Main$getCategoryMembers = F2(
	function (category, $continue) {
		var args = {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'action', _1: 'query'},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'list', _1: 'categorymembers'},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'cmlimit', _1: '500'},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'origin', _1: '*'},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'format', _1: 'json'},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'cmtitle', _1: category},
								_1: {ctor: '[]'}
							}
						}
					}
		...
		var url = A3(
			_mmachenry$whats_a_word_that$Main$mkUrl,
			_mmachenry$whats_a_word_that$Main$wikiHost,
			'/w/api.php?',
			function () {
				var _p2 = $continue;
				if (_p2.ctor === 'Just') {
					return {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'cmcontinue', _1: _p2._0},
						_1: args
					};
				} else {
					return args;
...
var _mmachenry$whats_a_word_that$Main$loadMore = function (model) {
	if (model.visible) {
		var _p3 = model.subCategories;
		if (_p3.ctor === '::') {
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{subCategories: _p3._1}),
				_1: A2(_mmachenry$whats_a_word_that$Main$getCategoryMembers, _p3._0.title, _elm_lang$core$Maybe$Nothing)
			};
		} else {
			var _p4 = model.$continue;
			if (_p4.ctor === 'Just') {
				return {
					ctor: '_Tuple2',
					_0: model,
				...
				if (_p5._0.ctor === 'Err') {
					...
					return _mmachenry$whats_a_word_that$Main$loadMore(
						_elm_lang$core$Native_Utils.update(
							...
							{
								error: _elm_lang$core$Maybe$Nothing,
								$continue: _p6.cmcontinue,
								pages: A2(
									_Skinney$elm_array_exploration$Array_Hamt$append,
									model.pages,
									_Skinney$elm_array_exploration$Array_Hamt$fromList(newPages)),
								subCategories: A2(_elm_lang$core$List$append, model.subCategories, newSubCats)
							}));
				}
			default:
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
...
var _mmachenry$whats_a_word_that$Main$UpdateVisibility = function (a) {
...
var _mmachenry$whats_a_word_that$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _mmachenry$whats_a_word_that$Main$onVisible(_mmachenry$whats_a_word_that$Main$UpdateVisibility),
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$core$Platform_Sub$map, _mmachenry$whats_a_word_that$Main$SetAutoState, _thebritican$elm_autocomplete$Autocomplete$subscription),
				_1: {ctor: '[]'}
			}
		});
};
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Html_Styled$text(page.title),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			});
	};
	var regex = _elm_lang$core$Regex$regex(model.regex);
	var matches = A2(
						...
						A2(
							...
							A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									_elm_lang$core$Basics$toString(
										_Skinney$elm_array_exploration$Array_Hamt$length(matches)),
									' matches')))),
					_1: {ctor: '[]'}
				}),
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled_Attributes$id('loadBtn'),
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled_Attributes$hidden(
									_elm_lang$core$Native_Utils.eq(model.$continue, _elm_lang$core$Maybe$Nothing) && _elm_lang$core$Native_Utils.eq(
										_elm_lang$core$List$length(model.subCategories),
										0)),
								_1: {ctor: '[]'}
							}
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _rtfeldman$elm_css$Html_Styled_Events$onClick(_mmachenry$whats_a_word_that$Main$LoadMore),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _rtfeldman$elm_css$Html_Styled$text('Load more...'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}),
...
var _mmachenry$whats_a_word_that$Main$Search = {ctor: 'Search'};
var _mmachenry$whats_a_word_that$Main$UpdateRegex = function (a) {
	return {ctor: 'UpdateRegex', _0: a};
};
var _mmachenry$whats_a_word_that$Main$UpdateCategory = function (a) {
	return {ctor: 'UpdateCategory', _0: a};
};
var _mmachenry$whats_a_word_that$Main$view = function (model) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$div,
		{
			ctor: '::',
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled_Attributes$placeholder('category'),
								_1: {
									ctor: '::',
									_0: _rtfeldman$elm_css$Html_Styled_Events$onInput(_mmachenry$whats_a_word_that$Main$UpdateCategory),
									_1: {
										ctor: '::',
										_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
											{
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _rtfeldman$elm_css$Html_Styled_Events$onClick(_mmachenry$whats_a_word_that$Main$Search),
									_1: {
										ctor: '::',
										_0: _rtfeldman$elm_css$Html_Styled_Attributes$disabled(
											_elm_lang$core$Native_Utils.eq(model.categoryInput, '')),
										_1: {
											ctor: '::',
											_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
												{ctor: '[]'}),
...
var _mmachenry$whats_a_word_that$Main$main = _elm_lang$html$Html$program(
	{
		init: _mmachenry$whats_a_word_that$Main$init,
		view: function (_p7) {
			return _rtfeldman$elm_css$Html_Styled$toUnstyled(
				_mmachenry$whats_a_word_that$Main$view(_p7));
		},
		update: _mmachenry$whats_a_word_that$Main$update,
		subscriptions: _mmachenry$whats_a_word_that$Main$subscriptions
	})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _mmachenry$whats_a_word_that$Main$main !== 'undefined') {
    _mmachenry$whats_a_word_that$Main$main(Elm['Main'], 'Main', undefined);
}
