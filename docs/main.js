				...
				_0: A2(
					_elm_lang$html$Html$a,
					{
						...
						_0: _elm_lang$html$Html_Attributes$href(
							A2(_elm_lang$core$Basics_ops['++'], 'https://en.wikipedia.org/wiki/', page.title)),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _mmachenry$whats_a_word_that$Main$main = _elm_lang$html$Html$program(
	{init: _mmachenry$whats_a_word_that$Main$init, view: _mmachenry$whats_a_word_that$Main$view, update: _mmachenry$whats_a_word_that$Main$update, subscriptions: _mmachenry$whats_a_word_that$Main$subscriptions})();
